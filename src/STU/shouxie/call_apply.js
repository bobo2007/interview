// "use strict";
// 模拟实现call  考虑基于函数扩展原型方法

// 要点： 
// 1. 第一个参数为空或null或undefined以普通函数形式调用(而不是以方法形式)  
// 2. 第一个参数为原始值 
// 3. 如何不覆盖对象属性  
// 4. 执行完后删除方法属性
Function.prototype.myCall = function(){
	...
	// 以上代码可以如下形式替换
	// context = new Object(context); 	// Object 构造函数也会像工厂方法一样，根据传入值的类型返回相应基本包装类型的实例
	// 或者
...
Function.prototype.myApply = function(context, args){
	...
	// 以上代码可以用下面的2种方式替换
	// context = new Object(context); 或者如下
	context = new context.constructor(context);
